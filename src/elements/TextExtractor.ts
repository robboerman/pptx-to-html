...
export class TextExtractor {
  ...
  static extract(
    ...
    for (const shape of Array.from(shapes)) {
      ...
      const groupXfrm = this.getGroupTransform(shape);
      if (groupXfrm) {
  ...
  /** Get group coordinate transform if the shape is inside a <grpSp> */
  private static getGroupTransform(shape: Element): {
